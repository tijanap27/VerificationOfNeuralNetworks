function flag = branch_and_bound_lp(W, b, xmin, xmax)
...
bounds = branch_and_bound_getBounds_lp(W, b, xmin, xmax);
...
if (bounds(1)>0)
    ...
    while true
        ...
        bounds_1 = branch_and_bound_getBounds_lp(W, b, transpose(x_bar_min_1), transpose(x_bar_max_1));
        ...
        bounds_2 = branch_and_bound_getBounds_lp(W, b, transpose(x_bar_min_2), transpose(x_bar_max_2));
